...
local function open_window(enter_insert)
  ...
  vim.api.nvim_set_option_value('number', false, { scope = 'win', win = M.state.win_id })
  vim.api.nvim_set_option_value('relativenumber', false, { scope = 'win', win = M.state.win_id })
